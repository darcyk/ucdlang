...
public final class EmailIngestModuleJobSettingsPanel extends IngestModuleIngestJobSettingsPanel {
	...
	private void initComponents() {
		...
		Mnemonics.setLocalizedText(neo4jPasswordLabel, NbBundle.getMessage(EmailIngestModuleJobSettingsPanel.class,
				"EmailIngestModuleIngestJobSettingsPanel.neo4jPasswordLabel.text"));
		Mnemonics.setLocalizedText(neo4jUriLabel, NbBundle.getMessage(EmailIngestModuleJobSettingsPanel.class,
				"EmailIngestModuleIngestJobSettingsPanel.neo4jUriLabel.text"));
		Mnemonics.setLocalizedText(neo4jUsernameLabel, NbBundle.getMessage(EmailIngestModuleJobSettingsPanel.class,
		...
		layout.setHorizontalGroup(layout.createSequentialGroup()
			.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				...
				.addComponent(neo4jUsernameLabel).addComponent(neo4jPasswordLabel))
			.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(addToGraphDatabaseCheckBox).addComponent(neo4jUriTextField)
				.addComponent(neo4jUsernameTextField).addComponent(neo4jPasswordTextField)));
